...
const CustomDrawer = (props) => {
  ...
  const drawerItems = [{ label: "Home", icon: "home", screenName: "Home" }];

  // Conditionally add "Portfolio" and "WatchList" options if the user is authenticated
  if (isAuthenticated) {
    drawerItems.push(
      { label: "Portfolio", icon: "wallet-sharp", screenName: "Portfolio" },
      { label: "WatchList", icon: "heart-sharp", screenName: "WatchList" }
    );
  }
  ...
  drawerItems.push(
    ...
    { label: "Contact Us", icon: "ios-mail", screenName: "ContactUs" }
  );
