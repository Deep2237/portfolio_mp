    ...
    <ScrollView style={styles.container}>
      <Text style={styles.heading}>Welcome to Our Stock Trading App</Text>
        ...
        <Text style={styles.paragraph}>
          Our stock trading app is designed to provide you with a seamless and intuitive trading
          experience. Stay updated with real-time market data, manage your portfolio, and make
          informed investment decisions.
        </Text>
        <Text style={styles.paragraph}>
          Whether you're a seasoned investor or just getting started, our app caters to all levels
          of expertise. Analyze stocks, track trends, and stay ahead of the game.
        </Text>
        ...
        <Text style={styles.creatorText}>
          This app was crafted by Nihar and Deep, passionate developers with a vision to
          simplify stock trading for everyone.
        </Text>
        </ScrollView>
  );
};
